...
const MangaPageLayout = ({
  ...
  const getLayoutClass = template => {
    switch (template) {
      case 'standard_4':
        return 'layout-standard-4';
      case 'vertical_story':
        return 'layout-vertical-story';
      case 'action_sequence':
        return 'layout-action-sequence';
      case 'dialogue_focus':
        return 'layout-dialogue-focus';
      case 'climax_spread':
        return 'layout-climax-spread';
      case 'intro_page':
        return 'layout-intro-page';
      default:
        return 'layout-standard-4';
    }
  };
